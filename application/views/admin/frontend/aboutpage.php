<div class="service">
    ...
    <div class="users_manage">
        ...
        <div class="row">
            <div class="col-xs-12">
                <h3 class="header smaller lighter blue">About Page Manager</h3>
                <div class="table-header">
                </div>
                <div>
                    <table id="about_manager" class="table table-striped table-bordered table-hover">
                        <thead>
                            <tr>
                                <th class=""></th>
                                <th>image</th>
...
<script>
    var about_manager = $('#about_manager').dataTable({
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": base_url + 'index.php/admin/features/ajax_list_AboutPage',
        "aoColumns": [
    ...
    $("#about_manager_wrapper #about_manager_length").html('<div class="col-xs-6"><div class="btn btn-primary"><a style="color: #fff;" href="' + base_url + 'index.php/admin/features/updateAboutPage' + '">Add About Content</a></div></div>');
    ...
    function render_action_aboutpage(data, type, full) {
        ...
        html += '<a href="' + base_url + 'index.php/admin/features/updateAboutPage/' + full.id + '" class="red"><i class="fa fa-edit bigger-130"></i></a>';
        html += '</div>';
        return html;
    }
    /**
