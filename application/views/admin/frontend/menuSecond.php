<div class="service">
    ...
    <div class="users_manage">
        ...
        <div class="row">
            <div class="col-xs-12">
                <div>
                    <a class="btn btn-success" href="<?php echo site_url('admin/frontend/update_menu_second') ?>">Add new</a>
                </div>
                <h3 class="header smaller lighter blue">Edit Menu Second</h3>
                <div class="table-header">
                </div>
                <div>
                    <table id="menu_second_manager" class="table table-striped table-bordered table-hover">
                        <thead>
                            <tr>
                                <th class=""></th>
                                <th>image</th>
...
<script>
    var menu_second_manager = $('#menu_second_manager').dataTable({
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": base_url + 'index.php/admin/frontend/ajax_list_menu_second',
        "aoColumns": [
    ...
    function render_action_menu_top(data, type, full) {
        ...
        html += '<a href="' + base_url + 'index.php/admin/frontend/update_menu_second/' + full.id + '" class="red"><i class="fa fa-edit bigger-130"></i></a>';
        html += '</div>';
        return html;
    }
    /**
        ...
        if (cf) {
            $.ajax({
                ...
                success: function(data) {
                    menu_second_manager.fnDraw(false);
                }
            });
        }
    }
