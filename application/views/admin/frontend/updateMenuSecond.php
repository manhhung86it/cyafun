<div class="service">
    ...
    <div class="">
        <div class="row">
            <form role="form" method="post" action="" id="form-features-update" class="span8" enctype="multipart/form-data">
                <div class="center-block" style="float: none;">
                    <div class="table-update center-block span6">
                        <div class="logo-register">
                            <?php if ($id == 0) { ?>
                                <span>ADD Menu second</span>
                            <?php } ?>
                            <?php if ($id != 0) { ?>
                                <span>UPDATE Menu second</span>
                            <?php } ?>
                        </div>                       
                        ...
                        <div class="form-group input-update">
                            ...
                            <div class="input-group">
                                <input type="text" value="<?php echo!empty($features['link']) ? $features['link'] : '' ?>" class="form-control input-lg" name="link" id="link">

                            </div>
                            <?php if (!empty($data_error['link'])): ?>
                                <label for="order" class="error"><?php echo $data_error['link'] ?></label>
                            <?php endif; ?>
                            <div id="link_validate">
                            </div>
                        </div>
                        <div class="form-group input-update" style="display: none;">
