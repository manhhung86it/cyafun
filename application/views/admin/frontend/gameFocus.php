<div class="service">
    ...
    <div class="users_manage">
        ...
        <div class="row">
            <div class="col-xs-12">
                <div>
                    <a class="btn btn-success" href="<?php echo site_url('admin/frontend/update_Game_Focus') ?>">Add new</a>
                </div>
                <h3 class="header smaller lighter blue">Edit Game Focus</h3>
                <div class="table-header">
                </div>
                <div>
                    <table id="game_focus_manager" class="table table-striped table-bordered table-hover">
                        <thead>
                            <tr>
                                <th class=""></th>
                                <th>image</th>
...
<script>
    var game_focus_manager = $('#game_focus_manager').dataTable({
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": base_url + 'index.php/admin/frontend/ajax_list_Game_Focus',
        "aoColumns": [
    ...
    function render_action_menu_top(data, type, full) {
        ...
        html += '<a href="' + base_url + 'index.php/admin/frontend/update_Game_Focus/' + full.id + '" class="red"><i class="fa fa-edit bigger-130"></i></a>';
        html += '</div>';
        return html;
    }
    /**
        ...
        if (cf) {
            $.ajax({
                ...
                success: function(data) {
                    game_focus_manager.fnDraw(false);
                }
            });
        }
    }
