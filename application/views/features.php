    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 feature-header">
                <span> <img src="<?php echo base_url(); ?>public/img/features_title.png" alt="" title="" ></span>
                <span class="feature-header-text"><h3 class="header smaller lighter">HOT FEATURES</h3></span>              
            </div>
