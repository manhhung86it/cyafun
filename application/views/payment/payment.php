<div class="" id="tabs-form-payment">
    <div class="tab-menu" id="tab-menu">
        ...
        <div class="input-update"><input type="radio" name="tab-menu-content" value="#other" checked="false" />other</div>
    </div>
    ...
    <form role="form" method="post" action="" id="other" class="span8" enctype="multipart/form-data">                      
        ...
        <div class="register-submit">
            <input class="btn btn-success" type="submit" name="submit"  id="submit_payment" value="submit">
        </div>
        <div class="register-submit">
            <a style="cursor: pointer;" onclick="history.back(1);">Cancel</a>
        </div>           
